  ...
  return (
    <div className="relative flex h-screen w-screen flex-col bg-black">
      ...
      <div className="absolute bottom-0 left-0 right-0 z-30 flex items-center justify-between gap-3 bg-black/55 px-6 pb-10 pt-4">
        ...
        {mediaReady && (
          <button
            className="rounded-xl bg-gray-700 px-4 py-3 text-center text-sm font-semibold text-white hover:bg-gray-600"
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mx-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              ...
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 10l1.5-1.5M14 10l-1.5-1.5" />
            </svg>
          </button>
        )}
